SamacSys ECAD Model
1912098/1311094/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ATTINY412-SSF" (originalName "ATTINY412-SSF")
	...
	(compDef "ATTINY412-SSF" (originalName "ATTINY412-SSF") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VDD") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "PA6") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "PA7") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "PA1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "PA3/EXTCLK") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "PA0/__RESET__/UPDI") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "PA2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ATTINY412-SSF"))
		...
		(attr "Manufacturer_Part_Number" "ATTINY412-SSF")
		(attr "Mouser Part Number" "579-ATTINY412-SSF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/ATTINY412-SSF?qs=3HJ2avRr9PLjr%252BAvU6bmFQ%3D%3D")
		(attr "Arrow Part Number" "ATTINY412-SSF")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/attiny412-ssf/microchip-technology?region=nac")
		(attr "Description" "8-bit Microcontrollers - MCU 20MHz, 4KB, SOIC8, Ind 125C, Green, Tube")
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/1/ATTINY412-SSF.pdf")
		(attr "Height" "1.75 mm")
	)
